document.addEventListener('DOMContentLoaded', () => {
    ...
    const prizes = [
        { id: 'S', name: "付箋 + パフェチケット", image: "prize_images/prize_S.png", weight: 1, maxOccurrences: 1, currentOccurrences: 0, description: "海のご褒美、召し上がれ♪" },
    ...
    function checkResult(finalResults) {
        if (finalResults[0].id === finalResults[1].id && finalResults[1].id === finalResults[2].id) {
            resultMessage.innerHTML = `<p>スタートを押してね！！</p>`; // 簡易メッセージ
