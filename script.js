document.addEventListener('DOMContentLoaded', () => {
    ...
    const prizes = [
        { id: 'A', name: "A賞：オリジナル マスキングテープ・付箋セット", image: "prize_images/prize_A.png", weight: 20, maxOccurrences: 50, currentOccurrences: 0, description: "おめでとう！波紋のように、ひらめきが広がる便利ツール！" },
        { id: 'B', name: "B賞：オリジナル バンダナ", image: "prize_images/prize_B.png", weight: 20, maxOccurrences: 50, currentOccurrences: 0, description: "大漁旗のように、あなたの個性をアピールしよう！" },
        { id: 'C', name: "C賞：オリジナル スマホスタンド", image: "prize_images/prize_C.png", weight: 20, maxOccurrences: 100, currentOccurrences: 0, description: "おめでとうございます！スマホも喜ぶ特等席！！" },
        { id: 'D', name: "D賞：オリジナル マグネットorボールペン", image: "prize_images/prize_D.png", weight: 25, maxOccurrences: 300, currentOccurrences: 0, description: "おめでとう！ピタッと大漁の幸運引き寄せ！！" },
        { id: 'E', name: "E賞：オリジナル クリアファイル", image: "prize_images/prize_E.png", weight: 20, maxOccurrences: 500, currentOccurrences: 0, description: "漁師の網の如く、整理整頓の達人へ！！" }
    ];
    ...
    function checkResult(finalResults) {
        if (finalResults[0].id === finalResults[1].id && finalResults[1].id === finalResults[2].id) {
            resultMessage.innerHTML = `<p>🎉 当選！ 🎉</p>`; // 簡易メッセージ
